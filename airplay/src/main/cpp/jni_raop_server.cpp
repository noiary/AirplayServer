...
Java_com_desaysv_module_airplay_RaopServer_start(JNIEnv *env, jobject object) {
    raop_t *raop;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_desaysv_module_airplay_RaopServer_getPort(JNIEnv *env, jobject object, jlong opaque) {
    raop_t *raop = (raop_t *) (void *) opaque;
    return raop_get_port(raop);
}

extern "C" JNIEXPORT void JNICALL
Java_com_desaysv_module_airplay_RaopServer_stop(JNIEnv *env, jobject object, jlong opaque) {
    raop_t *raop = (raop_t *) (void *) opaque;
